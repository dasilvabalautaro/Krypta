...
class Libp2pNode @Inject constructor(
     ...
     * resto ve un identificador estable. Como el descubrimiento real de Krypta es WAN (DHT +
     ...
     * identify ni provoca el hole punching que le entregaría nuestra IP (security-model §5.1).
     */
